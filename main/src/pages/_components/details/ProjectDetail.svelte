...
<div class="fixed top-0 left-0 right-0 bottom-0 flex justify-center items-center backdrop-filter backdrop-blur z-50 px-2">
  <div class="mt-8 bg-snow_white dark:bg-super_black px-4 md:px-6 pb-6 pt-4 rounded-lg shadow-md md:w-[760px] w-full  font-medium leading-6 min-h-[70vh] md:min-h-[460px] overflow-y-auto  text-secondary_bold">
